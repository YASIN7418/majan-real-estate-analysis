Majan Real Estate Market Analysis (Dubai)
A full data-driven real estate analysis using Python, SQL, Excel & Power BI
📌 Project Overview

This project analyzes 24 months of real estate transactions in Majan, Dubai using a complete data analytics pipeline.
...
| **.sql**  | All SQL queries with analysis  |
